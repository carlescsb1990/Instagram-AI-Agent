...
var getNextApiKey = function (currentApiKeyIndex) {
...
function handleError(error, currentApiKeyIndex, schema, prompt, runAgent) {
    return __awaiter(this, void 0, void 0, function () {
        var geminiApiKey, currentApiKeyName;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(error instanceof Error)) return [3 /*break*/, 5];
                    if (!error.message.includes("429 Too Many Requests")) return [3 /*break*/, 1];
                    logger_1.default.error("---GEMINI_API_KEY_".concat(currentApiKeyIndex + 1, " limit exhausted, switching to the next API key..."));
                    geminiApiKey = (0, exports.getNextApiKey)(currentApiKeyIndex);
                    currentApiKeyName = "GEMINI_API_KEY_".concat(currentApiKeyIndex + 1);
                    return [2 /*return*/, runAgent(schema, prompt)];
                case 1:
                    if (!error.message.includes("503 Service Unavailable")) return [3 /*break*/, 3];
                ...
                case 2:
                    ...
                    return [2 /*return*/, runAgent(schema, prompt)];
                case 3:
                    logger_1.default.error("Error generating training prompt: ".concat(error.message));
                    return [2 /*return*/, "An error occurred: ".concat(error.message)];
                case 4: return [3 /*break*/, 6];
                case 5:
                    logger_1.default.error("An unknown error occurred:", error);
                    return [2 /*return*/, "An unknown error occurred."];
